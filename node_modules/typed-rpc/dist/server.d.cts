import { J as JsonRpcRequest, R as RpcTranscoder, a as JsonRpcResponse } from './types-CVh5t9aB.cjs';
 ...
 */
declare function isJsonRpcRequest(req: unknown): req is JsonRpcRequest;
...
declare function handleRpc<T extends RpcService<T, V>, V = JsonValue>(request: unknown, service: T, options?: RpcHandlerOptions<V>): Promise<JsonRpcResponse>;

export { JsonRpcRequest, JsonRpcResponse, RpcTranscoder, handleRpc, isJsonRpcRequest };
export type { JsonValue, RpcHandlerOptions, RpcMethod, RpcService };
