...
// node_modules/@capacitor/http/dist/esm/web.js
...
var HttpPluginWeb = class extends WebPlugin {
  constructor() {
    super({
      name: "Http",
  ...
  getRequestHeader(headers, key) {
    ...
    const lowered = keys.reduce((newHeaders, key2, index) => {
      newHeaders[key2] = headers[originalKeys[index]];
      return newHeaders;
    }, {});
  ...
  setCookie(options) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (options.ageDays) {
        ...
        date.setTime(date.getTime() + options.ageDays * 24 * 60 * 60 * 1e3);
  ...
  clearCookies(_options) {
    return __awaiter(this, void 0, void 0, function* () {
      document.cookie.split(";").forEach((c) => document.cookie = c.replace(/^ +/, "").replace(/=.*/, `=;expires=${(/* @__PURE__ */ new Date()).toUTCString()};path=/`));
    });
  }
  uploadFile(options) {
    return __awaiter(this, void 0, void 0, function* () {
...
//# sourceMappingURL=@capacitor_http.js.map
